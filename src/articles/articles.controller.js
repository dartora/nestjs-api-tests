...
var ArticlesController = /** @class */ (function () {
    ...
    ArticlesController.prototype.findAll = function () {
        return this.articlesService.findAll();
    };
    ArticlesController.prototype.findOne = function (id) {
        return this.articlesService.findOne(+id);
    };
    ArticlesController.prototype.update = function (id, updateArticleDto) {
        return this.articlesService.update(+id, updateArticleDto);
    };
    ArticlesController.prototype.remove = function (id) {
